        ...
        child: Column(
          ...
          children: [
                        ...
                        DropdownMenuItem<String>(
                          ...
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                child: Text(
                                  LocaleKeys.changeAppointmentDate.tr(),
                                  maxLines: 1,
                                  overflow: TextOverflow.ellipsis,
                                  style: getBoldStyle(
                                    color: ColorManager.blackColor,
                      ...
                      onChanged: (String? value) {
                        if (value == 'edit') {
                          context
                              ...
                              .updateCurrentAppointmentId(appointment.id);

                          Navigator.pushNamed(
                              context, RoutersNames.previewPropertyScreen,
                              arguments: {
            ...
            Row(
              children: [
                SvgImageComponent(
                    width: 20, height: 20, iconPath: AppAssets.locationIcon),
                const SizedBox(
                  width: 8,
                ),
                Text(
              ...
              Row(
                children: [
                  ...
                  Text(
                    ...
                    style: getBoldStyle(
                        color: ColorManager.greenColor, fontSize: FontSize.s14),
                  ),
                ],
              ),
            if (appointment.orderStatus == 'cancelled')
              Row(children: [
                SvgImageComponent(
                  width: 20,
                  height: 20,
                  iconPath: AppAssets.cancelledIcon,
                  color: ColorManager.redColor,
                ),
                const SizedBox(
                  width: 8,
