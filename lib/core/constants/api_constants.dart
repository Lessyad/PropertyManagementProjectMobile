class ApiConstants {
  ...
  static const String baseUrl = "http://192.168.100.75:5000/api/";
  ...
  static const String propertyBusyDays =
      "${baseUrl}property-partner-busy-dates";
  ...
  static const String generateUploadUrls =
      "${baseUrl}ImageUpload/generate-upload-urls";
