...
import 'package:enmaa/core/services/pending_auth_navigation_service.dart';
...
class LoginBottomSheet {
  ...
  static void show({
    ...
    if (pendingRouteName != null) {
      PendingAuthNavigationService.setPendingRoute(
        routeName: pendingRouteName,
        arguments: pendingArguments,
      );
    }

    var clearPendingRouteOnDismiss = pendingRouteName != null;
      ...
      builder: (__) {
        return CustomBottomSheet(
          widget: LoginComponent(
            onLoginSelected: () {
              clearPendingRouteOnDismiss = false;
            },
          ),
...
class LoginComponent extends StatelessWidget {
  const LoginComponent({super.key, this.onLoginSelected});
          ...
          child: Row(
            ...
            children: [
              ...
              ButtonAppComponent(
                ...
                onTap: () {
                  onLoginSelected?.call();
                  Navigator.pushNamedAndRemoveUntil(context,
                      RoutersNames.authenticationFlow, (route) => false);
                },
              ),
            ],
          ),
